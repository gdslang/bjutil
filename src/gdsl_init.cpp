...
static bj_gdsl gdsl_init_elf_(gdsl::_frontend *f, std::string filename, std::string section_name, std::string function_name,
...
bj_gdsl gdsl_init_elf(gdsl::_frontend *f, std::string filename, std::string section_name, std::string function_name, size_t excess_bytes) {
  return gdsl_init_elf_(f, filename, section_name, function_name, [&](binary_provider::entry_t section, binary_provider::entry_t function) {
...
bj_gdsl gdsl_init_elf(gdsl::_frontend *f, std::string filename, std::string section_name, std::string function_name, bool full_section) {
  return gdsl_init_elf_(f, filename, section_name, function_name, [&](binary_provider::entry_t section, binary_provider::entry_t function) {
    if(full_section)
      return section.size;
    else return (function.offset - section.offset) + function.size;
  });
}
